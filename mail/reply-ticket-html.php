                                ...
                                <tr>
                                    <td class="content-block aligncenter" colspan="2"
                                        ...
                                        <a href="<?= $model->ticket->getUrl(true) ?>" class="btn-primary"
                                           style="font-weight: bold; color: #FFF; background-color: #348eda; border: solid #348eda; border-width: 10px 20px; line-height: 2em; text-decoration: none; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize;"><?= \powerkernel\support\Module::t('support',
                                                'View Ticket') ?></a>
                                    </td>
                                </tr>
